...
import com.aikeyboard.app.latin.InputAttributes
import com.aikeyboard.app.latin.R
import com.aikeyboard.app.latin.common.FileUtils
import com.aikeyboard.app.latin.define.DebugFlags
import com.aikeyboard.app.latin.settings.Settings
import com.aikeyboard.app.latin.utils.BackButton
import com.aikeyboard.app.latin.utils.DeviceProtectedUtils
import com.aikeyboard.app.latin.utils.ExecutorUtils
import com.aikeyboard.app.latin.utils.JniUtils
import com.aikeyboard.app.latin.utils.GestureDataPromotionReminderDialog
import com.aikeyboard.app.latin.utils.Theme
import com.aikeyboard.app.latin.utils.UncachedInputMethodManagerUtils
import com.aikeyboard.app.latin.utils.cleanUnusedMainDicts
import com.aikeyboard.app.latin.utils.prefs
import com.aikeyboard.app.settings.dialogs.ConfirmationDialog
import com.aikeyboard.app.settings.dialogs.NewDictionaryDialog
import com.aikeyboard.app.settings.screens.gesturedata.END_DATE_EPOCH_MILLIS
import com.aikeyboard.app.settings.screens.gesturedata.TWO_WEEKS_IN_MILLIS
